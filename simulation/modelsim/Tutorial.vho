...
-- pin_name1	=>  Location: PIN_V16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- C	=>  Location: PIN_L10,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \inst~combout\ = ( \A~input_o\ & ( \C~input_o\ ) ) # ( !\A~input_o\ & ( (\B~input_o\) # (\C~input_o\) ) )
